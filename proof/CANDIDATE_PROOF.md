# Imported candidate proof — audit pending

This is the mathematical argument imported from `Petersen_Pilot_Report.md`, reorganised as the candidate proof for the PROOF phase. It is **not independently accepted**. Direct computational reproduction has passed, but every mathematical obligation listed in `audit/OPEN_OBLIGATIONS.md` remains to be audited.
